    ...
    <section className="hero-section" id="home">
      ...
      <div className="intro-slide" id="slide1" ref={slide1}>
        ...
        <div className="intro-body">
          ...
          <h1 className="intro-title">A place that<br />feels like <em>home.</em></h1>
          <div className="intro-row">
            <p className="intro-sub">Come for the coffee. Stay for the warmth. Return because nothing else quite compares.</p>
            <div className="intro-stats">
              <div><span className="intro-stat-num">15+</span><span className="intro-stat-label">Years Brewing</span></div>
              <div><span className="intro-stat-num">4.9★</span><span className="intro-stat-label">Guest Rating</span></div>
              <div><span className="intro-stat-num">3</span><span className="intro-stat-label">Locations</span></div>
            </div>
          </div>
        </div>
      ...
      <div className="main-hero" id="slide2">
        ...
        <div className="main-hero-body">
          <div className="main-hero-eyebrow">Single Origin · Hand Poured · Made with Love</div>
          <h2 className="main-hero-title">Every pour,<br />a little <em>warmer.</em></h2>
